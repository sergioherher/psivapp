  ...
  <section class="sidebar">
    ...
    <?php endif; ?>
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li><a href="lista-documentos.php"><i class="fa fa-list-ul" aria-hidden="true"></i> Ver mis documentos</a></li>
          <li><a href="crear-documento.php"><i class="fa fa-plus-circle" aria-hidden="true"></i> Cargar</a></li>
        </ul>
      </li>
    </ul>
  </section>
